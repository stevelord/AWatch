...
void setup()
{
    ...
    //Initialize TWatch
    ttgo->begin();
    Serial.println("Watch init complete");
    ...
    */
    ...
    Serial.println("Click Handler Restart registered, setting up network.");
    //Setting up the network
    setupNetwork();


    Serial.println("Network setup complete. Setting up GUI...");
