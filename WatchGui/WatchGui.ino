...
lv_obj_t *setupGUI()
{
    ...
    cont_style.body.main_color = LV_COLOR_BLACK;
    cont_style.body.grad_color = LV_COLOR_BLACK;
    ...
    onestyle.text.color = LV_COLOR_CYAN;

    //Upper left corner logo
    lv_obj_t *head = lv_label_create(view, nullptr);
    lv_label_set_style(head, LV_LABEL_STYLE_MAIN, &onestyle);
    lv_label_set_text(head, "HIB");
    lv_obj_align(head, view, LV_ALIGN_IN_TOP_MID, -50, 10);
    ...
    model_style.text.color = LV_COLOR_CYAN;
    ...
    */
    ...
    style_line.line.color = LV_COLOR_MAGENTA;
    ...
    */
    ...
    static lv_point_t line_points2[] = { {10, 0}, {230, 0} };
    lv_obj_t *line2;
    ...
    lv_obj_align(line2, NULL, LV_ALIGN_IN_TOP_MID, 0, 45);
    ...
    */
    ...
    dot_style.text.color = LV_COLOR_WHITE;
    ...
    second_style.text.color = LV_COLOR_WHITE;
    ...
    year_style.text.color = LV_COLOR_WHITE;
    ...
    chinese_style.text.color = LV_COLOR_WHITE;
    ...
    */
    ...
    key_style.text.color = LV_COLOR_WHITE;
    ...
    bot_style.text.color = LV_COLOR_WHITE;
